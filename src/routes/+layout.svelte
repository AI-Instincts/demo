<script lang="ts">
  ...
  import "../app.css";
	import SalesNumbers from "$lib/components/SalesNumbers.svelte";
      ...
      <div class="relative mr-16 flex w-full max-w-xs flex-1">
        ...
        <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2 ring-1 ring-white/10">
          <div class="flex h-16 shrink-0 items-center">
            <img class="h-8 w-auto" src="/assets/Amplitech Logo Vector.png" alt="Your Company">
          </div>
    ...
    <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        ...
        <div class="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <!-- Profile dropdown -->
          <div class="relative">
            <button on:click={() => avatarOpen = !avatarOpen} type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              <span class="sr-only">Open user menu</span>
              <img class="h-8 w-8 rounded-full bg-gray-50" src="/assets/Tom Wright.png" alt="">
              <span class="hidden lg:flex lg:items-center">
                <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">Tom Wright</span>
            ...
            -->
            {#if avatarOpen}
            <div transition:fade={{duration: 100}} class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
